        ...
        <div class="col-sm-2 container sidebar">
            <form class="sidebar-form">
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <input class="form-control common_selector min_price" style="width:110% !important;"
                                placeholder="From" type="number" min="0" value="0" id="min_price">
                        </div>
                        <div class="col-sm-1" style="padding-top: 5px;padding-right:0px;padding-left:11px">
                            <span><b>-</b></span>
                        </div>
                        <div class="col-sm-5">
                            <input class="form-control common_selector max_price" style="width:110% !important;"
                                placeholder="To" type="number" min="0" value="{{App\Product::max('price')}}"
                                id="max_price">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input common_selector category" type="checkbox"
                            value="{{ $category->name }}">
                                ...
                                <div class="product">
                                    <a class="add-to-cart-btn" href="{{route('user.view',['id'=>$product->id])}}">
                                        <div class="product-img">
                                            <img src="{{asset('storage/' . $product->image)}}" width="95px"
                                                height="290px" alt="">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-name"><a
                                                href="{{route('user.view',['id'=>$product->id])}}">{{$product->name}}</a>
                                        </h3>
                                        <h4 class="product-price">
                                            {{$product->discount != null ? $product->discount : $product->price}} TND
